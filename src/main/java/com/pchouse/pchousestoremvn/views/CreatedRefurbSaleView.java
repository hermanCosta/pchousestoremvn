...
public class CreatedRefurbSaleView extends javax.swing.JInternalFrame {
    ...
    public CreatedRefurbSaleView(Sale saleModel, List<RefurbSale> listRefurbsSale, List<Deposit> listOrderDeposit, List<SalePayment> salePayments) {
        initComponents();
    ...
    private void payRefurbSale() {
        if (_saleModel != null) {
            int confirm = JOptionPane.showConfirmDialog(
                    this,
                    CommonConstant.CONFIRM_PAYMENT_SALE,
                    "Confirm Action",
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                if (employee != null) {
                    try {
                        ...
                        OrderNote orderNote = new OrderNote(_saleModel, _saleModel.getEmployee(), CommonConstant.REFURB_SALE_PICKED_NOTE, new Date());
        ...
        panel_input_detailLayout.setVerticalGroup(
            ...
            .addGroup(panel_input_detailLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_input_detailLayout.createSequentialGroup()
                    ...
                    .addComponent(scroll_pane_notes, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap()))
        );
        ...
        panel_refurb_sale_detailsLayout.setVerticalGroup(
            ...
            .addGroup(panel_refurb_sale_detailsLayout.createSequentialGroup()
                ...
                .addGroup(panel_refurb_sale_detailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(scroll_pane_refurbs, javax.swing.GroupLayout.DEFAULT_SIZE, 435, Short.MAX_VALUE))
