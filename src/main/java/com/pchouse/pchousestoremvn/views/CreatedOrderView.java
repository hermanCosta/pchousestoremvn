    ...
    private void btn_save_orderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_save_orderActionPerformed
        ...
        if (updateOrder != null) {
            ...
            if (isUpdated) {
                ...
                loadOrderDeposit(_depositController.getOrderDeposit(updateOrder));
                loadOrderFault(_orderFaultController.getOrderFaults(updateOrder));
                loadOrderProdServ(_orderProdServController.getOrderProdServ(updateOrder));
