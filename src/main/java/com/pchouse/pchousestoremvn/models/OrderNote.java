...
public class OrderNote implements Serializable {
    ...
    public OrderNote(ServiceOrder serviceOrder, Employee employee, String note, Date created) {
    ...
    public OrderNote(Sale sale, Employee employee, String note, Date created) {
        this.sale = sale;
        this.employee = employee;
        this.note = note;
        this.created = created;
